#
#  Be sure to run `pod spec lint AEPriceMatrix.podspec' to ensure this is a
...
This can be used for In-App Purchase tracking in a specific currency regardless of the local currency that the purchase was paid in. The following example tracks all revenue in EUR. See the In-App Purchase Programming Guide for details on how to implement a method like productForId: that finds an SKProduct by its product identifier.
  ...
  s.homepage     = "https://github.com/planetoDavid/AEPriceMatrix"
  ...
  s.author             = { "David Arve" => "david@planeto.com" }
  # Or just: s.author    = "David Arve"
  # s.authors            = { "David Arve" => "david@planeto.com" }
  # s.social_media_url   = "http://twitter.com/David Arve"
  ...
  s.source       = { :git => "https://github.com/planetoDavid/AEPriceMatrix.git", :tag => s.version.to_s }
  ...
  s.source_files  = "AEPriceMatrix", "AEPriceMatrix/**/*.{h,m}"
